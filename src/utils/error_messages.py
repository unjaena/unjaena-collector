...
ERROR_PATTERNS: List[Dict] = [
    ...
    {
        "pattern": r"(409|concurrent_collection|case_collection_in_progress)",
        "title": "Collection Session Conflict",
        "message": "A collection is already in progress for this case or a previous collection was terminated abnormally.",
        "solution": "Go to Web Platform -> Case Page -> Click [Cancel Operation], then get a new token.",
