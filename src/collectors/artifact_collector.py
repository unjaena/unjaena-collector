...
ARTIFACT_TYPES = {
    ...
    'mobile_android_bluetooth_pairings': {
        ...
        'paths': [], 'category': 'android', 'subcategory': 'basic',
        'requires_adb': True, 'requires_root': True,
        'collector': 'collect_android', 'artifact_key': 'bluetooth_pairings',
    },
    'mobile_android_dropbox_logs': {
        'name': 'Dropbox System Logs',
        'description': 'Boot, restart, app crash timeline',
        'paths': [], 'category': 'android', 'subcategory': 'basic',
        'requires_adb': True, 'requires_root': True,
        'collector': 'collect_android', 'artifact_key': 'dropbox_logs',
    },
    'mobile_android_batterystats': {
        'name': 'Battery Stats',
        'description': 'Per-app wake/run intervals (binary inventory)',
        'paths': [], 'category': 'android', 'subcategory': 'basic',
        'requires_adb': True, 'requires_root': True,
        'collector': 'collect_android', 'artifact_key': 'batterystats',
    },
    'mobile_android_downloads': {
        'name': 'Downloads',
        'description': 'System downloads provider (URL, filename, status)',
        'paths': [], 'category': 'android', 'subcategory': 'basic',
        'requires_adb': True, 'requires_root': True,
        'collector': 'collect_android', 'artifact_key': 'downloads',
    },
    'mobile_android_chrome_cookies': {
        'name': 'Chrome Cookies',
        'description': 'Chrome cookies (session attribution, login forensics)',
        'paths': [], 'category': 'android', 'subcategory': 'app_email_browser',
        'requires_adb': True, 'requires_root': True,
        'collector': 'collect_android', 'artifact_key': 'chrome_cookies',
    },
    'mobile_android_chrome_login_data': {
        'name': 'Chrome Login Data',
        'description': 'Chrome saved-credential metadata (autofill)',
        'paths': [], 'category': 'android', 'subcategory': 'app_email_browser',
        'requires_adb': True, 'requires_root': True,
        'collector': 'collect_android', 'artifact_key': 'chrome_login_data',
    },
    'mobile_android_chrome_bookmarks': {
        'name': 'Chrome Bookmarks',
        'description': 'Chrome bookmarks (JSON)',
        'paths': [], 'category': 'android', 'subcategory': 'app_email_browser',
        'requires_adb': True, 'requires_root': True,
        'collector': 'collect_android', 'artifact_key': 'chrome_bookmarks',
    },
    'mobile_android_google_maps': {
        'name': 'Google Maps',
        'description': 'Maps searches, places, route history',
        'paths': [], 'category': 'android', 'subcategory': 'app_email_browser',
        'requires_adb': True, 'requires_root': True,
        'collector': 'collect_android', 'artifact_key': 'google_maps',
    },
    'mobile_android_google_pay': {
        'name': 'Google Pay / Wallet',
        'description': 'Google Wallet card history',
        'paths': [], 'category': 'android', 'subcategory': 'app_email_browser',
        'requires_adb': True, 'requires_root': True,
        'collector': 'collect_android', 'artifact_key': 'google_pay',
    },
    'mobile_android_locksettings': {
        'name': 'Lock Settings',
        'description': 'PIN/pattern attempt counters + lockout state',
        'paths': [], 'category': 'android', 'subcategory': 'basic',
        'requires_adb': True, 'requires_root': True,
        'collector': 'collect_android', 'artifact_key': 'locksettings',
    },
    ...
    'mobile_ios_mail_envelope': {
        ...
        'paths': [], 'category': 'ios', 'subcategory': 'core',
        'requires_backup': True,
        'collector': 'collect_ios', 'artifact_key': 'mail_envelope',
    },
    'mobile_ios_safari_cookies': {
        'name': 'Safari Cookies',
        'description': 'Safari root cookie jar (binarycookies)',
        'paths': [], 'category': 'ios', 'subcategory': 'core',
        'requires_backup': True,
        'collector': 'collect_ios', 'artifact_key': 'safari_cookies',
    },
    'mobile_ios_interaction_c': {
        'name': 'CoreDuet Interactions',
        'description': 'Contact-of-interest scoring, communication frequency',
        'paths': [], 'category': 'ios', 'subcategory': 'system',
        'requires_backup': True,
        'collector': 'collect_ios', 'artifact_key': 'interaction_c',
    },
    'mobile_ios_routined': {
        ...
        'paths': [], 'category': 'ios', 'subcategory': 'system',
        'requires_backup': True,
        'collector': 'collect_ios', 'artifact_key': 'routined',
    },
    'mobile_ios_biome': {
        'name': 'Biome Streams',
        'description': 'iOS 16+ Biome SEGB streams (app launches, lock, focus)',
        'paths': [], 'category': 'ios', 'subcategory': 'system',
        'requires_backup': True,
        'collector': 'collect_ios', 'artifact_key': 'biome',
    },
