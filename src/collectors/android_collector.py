...
ANDROID_ARTIFACT_TYPES: Dict[str, Dict[str, Any]] = {}
...
class AndroidCollector:
    ...
    # Server only has base types (e.g., mobile_android_profile_target), not
    ...
    def _collect_system_info(
        ...
        Each sub-type yields with a stable artifact_type for downstream processing.
        """
    ...
    def _collect_call_log_fallback(
        ...
        # Prefix with marker so downstream processing can detect the fallback format.
    ...
    def _collect_reserved_extension(
        self,
        artifact_type: str,
        artifact_info: Dict[str, Any],
        output_dir: Path,
        ...
        """Reserved extension hook; not included in the public collector build."""
        yield '', {
            'artifact_type': artifact_type,
            'status': 'not_supported',
            'error': 'This collection method is not included in this build.',
        }
