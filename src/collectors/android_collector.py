...
class AndroidCollector:
    ...
    def _uninstall_agent_apk(self):
        """Remove Agent APK and release ADB reverse after collection (minimal device modification)."""
        try:
            output, rc = self._run_system_adb(
    ...
    def _start_agent_scraping(
        ...
        # Pass token via file instead of broadcast extras to avoid logcat exposure
